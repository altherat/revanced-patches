...
# Steps
1. Install [RedReader](https://github.com/QuantumBadger/RedReader/releases) from an APK or the [Google Play Store](https://play.google.com/store/apps/details?id=org.quantumbadger.redreader)
